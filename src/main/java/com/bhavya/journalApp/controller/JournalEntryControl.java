...
import com.bhavya.journalApp.entity.JournalEntry;
import com.bhavya.journalApp.entity.User;
import com.bhavya.journalApp.service.JournalEntryService;
    ...
    public ResponseEntity<?> updateJournalEntryById(@RequestBody JournalEntry newEntry, @PathVariable ObjectId myId) {
        ...
        if (!collect.isEmpty()) {
            ...
            if (journalEntry.isPresent()) {
                ...
                return new ResponseEntity<>(old, HttpStatus.RESET_CONTENT);
            }
        }
        return new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }
